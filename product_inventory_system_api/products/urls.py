...
from .views import create_product, ProductListView, add_stock, remove_stock, DeleteProduct
...
urlpatterns = [
    ...
    path('products/<int:productid>/delete_product/', DeleteProduct, name='delete-product'),
]
